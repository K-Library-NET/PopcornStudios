...
namespace PStudio.WinApp.Aircraft.FDAPlatform.Domain
{
    ...
    public sealed partial class FlightAnalysis : AircraftDataAnalysisWinRT.Common.LayoutAwarePage
    {
        ...
        private void OnNavigateToGrid_Clicked(object sender, RoutedEventArgs e)
        {
            AircraftDataAnalysisWinRT.MyControl.GridDataDisplayArg arg = new AircraftDataAnalysisWinRT.MyControl.GridDataDisplayArg()
            {
                StartSecond = m_viewModel.CurrentStartSecond,
                EndSecond = m_viewModel.CurrentEndSecond,
                ViewModel = m_viewModel,
                ParameterIDs = this.SelectedIds(m_viewModel)
            };

            this.Frame.Navigate(typeof(AircraftDataAnalysisWinRT.MyControl.GridDataPage), arg);
        }
