...
{
    class LevelRecordsStepSecondsHandler : StepSecondsFastDataReadingStepHandler
    {
        public LevelRecordsStepSecondsHandler(int startSecond, int endSecond, bool putIntoServer,
