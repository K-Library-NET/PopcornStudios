...
namespace AircraftDataAnalysisWcfService.DALs
{
    ...
    public class AircraftMongoDbDal : IDisposable
    {
        ...
        internal MongoCollection<FlightDataEntities.Decisions.DecisionRecord>
        ...
        internal MongoCollection<FlightRawDataRelationPoint> GetFlightRawDataRelationPointsMongoCollection(MongoDatabase database, string flightID)
        {
