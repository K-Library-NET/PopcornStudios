...
namespace AircraftDataAnalysisModel1.WinRT.AircraftDataInput {
    ...
    public partial class Flight : object, System.ComponentModel.INotifyPropertyChanged {
        ...
        private System.Collections.ObjectModel.ObservableCollection<AircraftDataAnalysisModel1.WinRT.AircraftDataInput.GlobeData> GlobeDatasField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Collections.ObjectModel.ObservableCollection<AircraftDataAnalysisModel1.WinRT.AircraftDataInput.GlobeData> GlobeDatas {
            get {
    ...
    public interface IAircraftDataInput {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAircraftDataInput/AddOrReplaceFlightGlobeDataBatch", ReplyAction="http://tempuri.org/IAircraftDataInput/AddOrReplaceFlightGlobeDataBatchResponse")]
        System.Threading.Tasks.Task<string> AddOrReplaceFlightGlobeDataBatchAsync(string flightId, AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftModel model, int startIndex, int endIndex, System.Collections.ObjectModel.ObservableCollection<AircraftDataAnalysisModel1.WinRT.AircraftDataInput.GlobeData> globedatas);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAircraftDataInput/AddOrReplaceAircraftInstance", ReplyAction="http://tempuri.org/IAircraftDataInput/AddOrReplaceAircraftInstanceResponse")]
        System.Threading.Tasks.Task<string> AddOrReplaceAircraftInstanceAsync(AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftInstance instance);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAircraftDataInput/DeleteAircraftInstance", ReplyAction="http://tempuri.org/IAircraftDataInput/DeleteAircraftInstanceResponse")]
        System.Threading.Tasks.Task<string> DeleteAircraftInstanceAsync(AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftInstance instance);
    }
    ...
    public partial class AircraftDataInputClient : System.ServiceModel.ClientBase<AircraftDataAnalysisModel1.WinRT.AircraftDataInput.IAircraftDataInput>, AircraftDataAnalysisModel1.WinRT.AircraftDataInput.IAircraftDataInput {
        ...
        public System.Threading.Tasks.Task<string> AddOrReplaceFlightGlobeDataBatchAsync(string flightId, AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftModel model, int startIndex, int endIndex, System.Collections.ObjectModel.ObservableCollection<AircraftDataAnalysisModel1.WinRT.AircraftDataInput.GlobeData> globedatas) {
            return base.Channel.AddOrReplaceFlightGlobeDataBatchAsync(flightId, model, startIndex, endIndex, globedatas);
        }
        
        public System.Threading.Tasks.Task<string> AddOrReplaceAircraftInstanceAsync(AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftInstance instance) {
            return base.Channel.AddOrReplaceAircraftInstanceAsync(instance);
        }
        
        public System.Threading.Tasks.Task<string> DeleteAircraftInstanceAsync(AircraftDataAnalysisModel1.WinRT.AircraftDataInput.AircraftInstance instance) {
            return base.Channel.DeleteAircraftInstanceAsync(instance);
        }
