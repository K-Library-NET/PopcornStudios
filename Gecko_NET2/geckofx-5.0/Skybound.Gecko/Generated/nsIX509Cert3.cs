...
namespace Skybound.Gecko
{
	...
	public interface nsIX509Cert3 : nsIX509Cert2
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetUsagesArray([MarshalAs(UnmanagedType.Bool)] bool ignoreOcsp, ref uint verified, ref uint count, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Skybound.Gecko.CustomMarshalers.WStringMarshaler", SizeParamIndex=2)] ref string usages);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetUsagesString([MarshalAs(UnmanagedType.Bool)] bool ignoreOcsp, ref uint verified, [MarshalAs(UnmanagedType.LPStruct)] nsAString usages);
