...
namespace Pstudio.MVC.Entities.Imports
{
    ...
    public class ImportApply
    {
        ...
        public virtual ICollection<ImportApplyProduct> ImportApplyProducts
        {
            get;
            set;
        }

        public virtual ICollection<ImportApplyChangeRecord> ImportApplyChangeRecords
        {
            get;
            set;
        }
