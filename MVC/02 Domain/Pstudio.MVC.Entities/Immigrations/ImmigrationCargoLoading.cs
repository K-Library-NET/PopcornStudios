...
namespace Pstudio.MVC.Entities.Immigrations
{
    ...
    /// 入境准装准卸单
    /// </summary>
    public class ImmigrationCargoLoading
    {
        ...
        public virtual ImmigrationApply ImmigrationApply
        {
            get;
            set;
        }

        public virtual ICollection<ImmigrationCargoLoadingProduct>
            ImmigrationCargoLoadingProducts { get; set; }
    }
}
