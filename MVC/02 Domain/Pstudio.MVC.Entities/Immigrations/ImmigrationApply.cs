...
namespace Pstudio.MVC.Entities.Immigrations
{
    ...
    public class ImmigrationApply
    {
        ...
        /// <summary>
        /// 申报状态：0已申报、1已出境（完成）、2待布控查验、3布控查验通过、
        /// 4一级审核通过、5二级审核通过、6准装准卸、7申报货物已出境
        /// -1已撤销、-2不通过 
        /// </summary>
        public int Status
        {
        ...
        public virtual ICollection<ImmigrationApplyProduct> ImmigrationApplyProducts
        {
            get;
            set;
        }

        public virtual ICollection<ImmigrationApplyChangeRecord> ImmigrationApplyChangeRecords
        {
            get;
            set;
        }
